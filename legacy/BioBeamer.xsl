...
<body>
	...
	<p>
	source: $HeadURL: http://fgcz-svn.uzh.ch/repos/fgcz/stable/proteomics/config/BioBeamer.xsl $; $Date: 2015-12-09 16:49:33 +0100 (Wed, 09 Dec 2015) $; $Author: cpanse $
	</p>
...
<xsl:template match="host">
	...
	robocopy_args
      	...
      	<td>
	<xsl:value-of select="@robocopy_args"/> Bytes
      	</td>
      </tr>
      </table>
